...
public class Hanoi {
	...
	private Iterator<Integer> getLeftIterator() {
	...
	private Iterator<Integer> getMiddleIterator() {
		return new Iterator<Integer>() {
			int i = 0;
	...
	private Iterator<Integer> getRightIterator() {
		return new Iterator<Integer>() {
			int i = 0;
